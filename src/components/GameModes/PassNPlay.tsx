...
const PassNPlay = (props: Props) => {
  return (
    <>
      ...
      >
        <span className="underline">Pass N Play</span>
        <p
          className={`${bebas.className} text-base tracking-widest text-gray-200`}
        >
          Where chess transcends the board!
        </p>
        <ChevronDown className="animate-bounce" />
      </AccordionButton>
      <AccordionPanel
        className={`${monst.className}  text-gray-200 backdrop-hue-rotate-[40deg] p-2 rounded`}
        pb={4}
      >
